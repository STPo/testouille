 ...
 * 
 * CVS FILE $Id: config.php,v 1.80 2011/12/30 23:02:51 joku Exp $
 * 
...
$BBC_MAINSITE = "http://www.parmotsetparlettres.fr/";
...
$BBC_DETAILED_STAT_FIELDS = "id, time, ext, dns, visits, os, browser, referer, page";
...
// $BBC_EXT_LOOKUP = "GEOIP";  => Use GeoIP PHP API plug-in 
// (See http://www.maxmind.com/app/php)to Look-Up IP addresses
...
$BBC_IGNORE_IP = "82.224.26.93"; // STPo IP!
...
$BBC_CSS_FILE = "default.css";

// Generate the page load-time in seconds
